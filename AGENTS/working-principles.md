...
cf. [ingest-workflow.md](../_docs/_architecture/ingest-workflow.md) "AI가 단정하지 않는다", [AGENTS.md](../AGENTS.md) 문서 작성 스타일의 사실, 의견, 주체 구분.
...
cf. [core-constraints.md](../_docs/_architecture/core-constraints.md) 원본 보호 원칙 — 되돌릴 수 없는 변경을 삼가는 가역성 정신과 통한다.
