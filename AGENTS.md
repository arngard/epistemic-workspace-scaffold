...
3. 의미 감사 트리거를 `python3 AGENTS/tools/check_semantic_audit.py .`로 판정하고, 충족이면 착수 전 epistemic-auditor로 의미 감사를 받고 STATUS를 갱신한다 (판정 기준과 기준점 커밋은 [AGENTS/agent-roles.md](AGENTS/agent-roles.md) "호출 시점").
