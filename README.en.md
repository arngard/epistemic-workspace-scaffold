...
- Small documents + folder descriptors: read a folder's AGENTS.md guide first and open only what is needed. Saves tokens; also less taxing for humans to read.
